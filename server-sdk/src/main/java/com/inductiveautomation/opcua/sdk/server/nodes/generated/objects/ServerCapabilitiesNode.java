...
public class ServerCapabilitiesNode extends BaseObjectNode implements ServerCapabilitiesType {
    ...
    public OperationLimitsType getOperationLimits() {
        Optional<com.inductiveautomation.opcua.sdk.core.nodes.ObjectNode> operationLimits = getObjectComponent("OperationLimits");

        return operationLimits.map(node -> (OperationLimitsType) node).orElse(null);
    }

    public FolderType getModellingRules() {
        Optional<com.inductiveautomation.opcua.sdk.core.nodes.ObjectNode> modellingRules = getObjectComponent("ModellingRules");
    ...
    public ServerVendorCapabilityType getVendorCapability() {
        Optional<com.inductiveautomation.opcua.sdk.core.nodes.VariableNode> vendorCapability = getVariableComponent("VendorCapability");
