...
import com.inductiveautomation.opcua.sdk.core.model.variables.TwoStateDiscreteType;
...
public class TwoStateDiscreteNode extends DiscreteItemNode implements TwoStateDiscreteType {
    ...
    @Override
    public void setFalseState(LocalizedText falseState) {
    ...
    @Override
    public void setTrueState(LocalizedText trueState) {
